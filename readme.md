...
O site apresenta uma experiência visual inspirada em tons árabes e sofisticados, refletindo a essência da marca — **perfumes que encantam e despertam os sentidos**.
...
│ ├── js/ → scripts e funcionalidades (script.js, quiz.js)
│ └── pages/ → páginas adicionais (historia, produtos, quiz, tecnologia, contato)
│
...
- **Produtos:** Lista de perfumes com imagens, descrição e preços.  
- **Quiz interativo:** Jogo educativo sobre o mundo dos perfumes.  
- **Contato:** Formulário funcional com campos de nome, e-mail e mensagem.  
- **Footer dinâmico:** Links para redes sociais e informações da loja.  
